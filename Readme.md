...
* Студент: [Katrusik Cheremisova](https://up.htmlacademy.ru/htmlcss/27/user/1347589).
* Наставник: `Никита Рогатнв`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1347589-sedona-27) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
